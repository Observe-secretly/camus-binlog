...
public class KafkaCluster {
    ...
    private static KafkaServer startBroker(Properties props) {
        // TODO modify to limin
        Option<String> noThreadNamePrefix = Option.empty();
        KafkaServer server = new KafkaServer(KafkaConfig.fromProps(props),
                                             (Time) new org.apache.kafka.common.utils.SystemTime(), noThreadNamePrefix,
